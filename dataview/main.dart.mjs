...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1341: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _1357: x0 => x0.webkitGetAsEntry(),
      _1361: x0 => x0.cancel(),
      _1364: x0 => x0.read(),
      _1366: x0 => ({type: x0}),
      _1367: (x0,x1) => new Blob(x0,x1),
      _1370: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1370(f,arguments.length,x0,x1,x2) }),
      _1371: (x0,x1) => x0.append(x1),
      _1373: x0 => x0.remove(),
      _1374: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1375: (x0,x1) => x0.removeAttribute(x1),
      _1377: (x0,x1) => x0.getResponseHeader(x1),
      _1400: (x0,x1) => x0.item(x1),
      _1403: (x0,x1) => { x0.csp = x1 },
      _1404: x0 => x0.csp,
      _1405: (x0,x1) => x0.getCookieExpirationDate(x1),
      _1406: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1407: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1408: (x0,x1) => x0.createElement(x1),
      _1413: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1414: x0 => x0.createReader(),
      _1415: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1415(f,arguments.length,x0) }),
      _1416: (x0,x1) => x0.readEntries(x1),
      _1417: () => new Blob(),
      _1418: (x0,x1,x2,x3) => x0.slice(x1,x2,x3),
      _1419: x0 => globalThis.URL.createObjectURL(x0),
      _1420: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1420(f,arguments.length,x0) }),
      _1421: (x0,x1) => x0.file(x1),
      ...
      _1436: (x0,x1) => x0.querySelector(x1),
      _1437: (x0,x1) => x0.item(x1),
      _1438: () => new FileReader(),
      _1440: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1445: (x0,x1) => x0.removeChild(x1),
      _1446: x0 => x0.click(),
      _1450: Date.now,
      _1452: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1453: s => {
      ...
      _1455: () => typeof dartUseDateNowForTicks !== "undefined",
      _1456: () => 1000 * performance.now(),
      _1457: () => Date.now(),
      _1458: () => {
      ...
      _1460: () => new WeakMap(),
      _1461: (map, o) => map.get(o),
      _1462: (map, o, v) => map.set(o, v),
      _1463: x0 => new WeakRef(x0),
      _1464: x0 => x0.deref(),
      _1471: () => globalThis.WeakRef,
      ...
      _1488: Object.is,
      _1489: o => o instanceof Array,
      _1490: (a, i) => a.push(i),
      _1491: (a, i) => a.splice(i, 1)[0],
      _1493: (a, l) => a.length = l,
      _1494: a => a.pop(),
      _1495: (a, i) => a.splice(i, 1),
      _1496: (a, s) => a.join(s),
      _1497: (a, s, e) => a.slice(s, e),
      _1498: (a, s, e) => a.splice(s, e),
      _1499: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1500: a => a.length,
      _1501: (a, l) => a.length = l,
      _1502: (a, i) => a[i],
      _1503: (a, i, v) => a[i] = v,
      _1505: o => {
      ...
      _1506: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1508: o => o instanceof Uint8Array,
      _1509: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1510: o => o instanceof Int8Array,
      _1511: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1512: o => o instanceof Uint8ClampedArray,
      _1513: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1514: o => o instanceof Uint16Array,
      _1515: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1516: o => o instanceof Int16Array,
      _1517: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1518: o => o instanceof Uint32Array,
      _1519: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1520: o => o instanceof Int32Array,
      _1521: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1523: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1524: o => o instanceof Float32Array,
      _1525: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1526: o => o instanceof Float64Array,
      ...
      _1549: Function.prototype.call.bind(DataView.prototype.getBigUint64),
      ...
      _1570: (handle) => clearTimeout(handle),
      _1571: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1572: (handle) => clearInterval(handle),
      _1573: (c) =>
      ...
      _1628: x0 => x0.groups,
      _1629: x0 => x0.flags,
      _1630: x0 => x0.multiline,
      _1631: x0 => x0.ignoreCase,
      _1632: x0 => x0.unicode,
      _1633: x0 => x0.dotAll,
      _1634: (x0,x1) => { x0.lastIndex = x1 },
      _1635: (o, p) => p in o,
      _1636: (o, p) => o[p],
      _1637: (o, p, v) => o[p] = v,
      _1640: () => new XMLHttpRequest(),
      _1641: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1643: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1644: (x0,x1) => x0.send(x1),
      _1645: x0 => x0.send(),
      ...
      _1655: () => new AbortController(),
      _1656: x0 => x0.abort(),
      _1657: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1658: (x0,x1) => globalThis.fetch(x0,x1),
      _1659: (x0,x1) => x0.get(x1),
      _1660: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1660(f,arguments.length,x0,x1,x2) }),
      _1661: (x0,x1) => x0.forEach(x1),
      _1662: x0 => x0.getReader(),
      ...
      _1690: Function.prototype.call.bind(BigInt.prototype.toString),
      _1691: Function.prototype.call.bind(Number.prototype.toString),
      _1692: (d, digits) => d.toFixed(digits),
      _1696: () => globalThis.document,
      _1702: (x0,x1) => { x0.height = x1 },
      _1704: (x0,x1) => { x0.width = x1 },
      _1713: x0 => x0.style,
      _1716: x0 => x0.src,
      _1717: (x0,x1) => { x0.src = x1 },
      _1718: x0 => x0.naturalWidth,
      _1719: x0 => x0.naturalHeight,
      _1735: x0 => x0.status,
      _1736: (x0,x1) => { x0.responseType = x1 },
      _1738: x0 => x0.response,
      _1783: x0 => x0.status,
      _1786: (x0,x1) => { x0.responseType = x1 },
      _1787: x0 => x0.response,
      _1788: x0 => x0.responseText,
      _1847: (x0,x1) => { x0.draggable = x1 },
      _1863: x0 => x0.style,
      _2339: x0 => x0.src,
      _2340: (x0,x1) => { x0.src = x1 },
      _2343: x0 => x0.name,
      _2344: (x0,x1) => { x0.name = x1 },
      _2345: x0 => x0.sandbox,
      _2346: x0 => x0.allow,
      _2347: (x0,x1) => { x0.allow = x1 },
      _2348: x0 => x0.allowFullscreen,
      _2349: (x0,x1) => { x0.allowFullscreen = x1 },
      _2354: x0 => x0.referrerPolicy,
      _2355: (x0,x1) => { x0.referrerPolicy = x1 },
      _2792: (x0,x1) => { x0.accept = x1 },
      _2806: x0 => x0.files,
      _2832: (x0,x1) => { x0.multiple = x1 },
      _2850: (x0,x1) => { x0.type = x1 },
      _3550: x0 => x0.items,
      _3553: (x0,x1) => x0[x1],
      _3557: x0 => x0.length,
      _3561: x0 => x0.dataTransfer,
      _3565: () => globalThis.window,
      _3627: x0 => x0.navigator,
      _3698: (x0,x1) => { x0.ondragenter = x1 },
      _3700: (x0,x1) => { x0.ondragleave = x1 },
      _3702: (x0,x1) => { x0.ondragover = x1 },
      _3706: (x0,x1) => { x0.ondrop = x1 },
      _4016: x0 => x0.userAgent,
      _4017: x0 => x0.vendor,
      _6130: x0 => x0.type,
      _6171: x0 => x0.signal,
      _6232: x0 => x0.firstChild,
      _6243: () => globalThis.document,
      _6325: x0 => x0.body,
      _6656: x0 => x0.id,
      _6657: (x0,x1) => { x0.id = x1 },
      _6684: x0 => x0.children,
      _6887: x0 => x0.length,
      _6989: x0 => x0.clientX,
      _6990: x0 => x0.clientY,
      _8001: x0 => x0.value,
      ...
      _8181: x0 => x0.type,
      _8188: x0 => x0.name,
      _8189: x0 => x0.lastModified,
      _8194: x0 => x0.length,
      _8199: x0 => x0.result,
      _8696: x0 => x0.url,
      _8698: x0 => x0.status,
      _8700: x0 => x0.statusText,
      _8701: x0 => x0.headers,
      _8702: x0 => x0.body,
      _10828: (x0,x1) => { x0.border = x1 },
      _11106: (x0,x1) => { x0.display = x1 },
      _11270: (x0,x1) => { x0.height = x1 },
      _11960: (x0,x1) => { x0.width = x1 },
      _12328: x0 => x0.name,
      _13013: x0 => x0.isDirectory,
      _13014: x0 => x0.name,
      _13015: x0 => x0.fullPath,
